    ...
    <div class="popular-place-last-week">
        ...
        <div class="popular-place-last-week__visited__slideShow">
          ...
          <p class="popular-place-last-week__visited__controller">
            <img src="@/assets/next.png" class="popular-place-last-week__visited__prev" @click="moveLeft" />
            <img src="@/assets/next.png" class="popular-place-last-week__visited__next" @click="moveRight" />
          </p>
        </div>
      </div>
    </div>
