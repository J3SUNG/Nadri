  ...
  <div class="board">
    ...
    <div class="board__pagenation__box">
      ...
      <button
        :class="{
          board__pagenation: true,
          board__pagenation__selected: this.selected[0],
        }"
      ...
      <button
        :class="{
          board__pagenation: true,
          board__pagenation__selected: this.selected[1],
          board__pagenation__hidden: this.pageNav.totalPageCount < 2,
        }"
        @click="movePage(startPage + 1)"
      >
        {{ this.startPage + 1 }}
      ...
      <button
        :class="{
          board__pagenation: true,
          board__pagenation__selected: this.selected[2],
          board__pagenation__hidden: this.pageNav.totalPageCount < 3,
        }"
      ...
      <button
        :class="{
          board__pagenation: true,
          board__pagenation__selected: this.selected[3],
          board__pagenation__hidden: this.pageNav.totalPageCount < 4,
        }"
      ...
      <button
        :class="{
          board__pagenation: true,
          board__pagenation__selected: this.selected[4],
          board__pagenation__hidden: this.pageNav.totalPageCount < 5,
        }"
...
export default {
  ...
  methods: {
    ...
    movePage(page) {
      ...
      http
        .get(
          `board?pg=${this.nextPage}&type=${this.type}&key=${this.searchType}&word=${this.search}`
        )
        .then((response) => {
          this.boards = response.data.list;
          this.pageNav = response.data.pageNavigation;
