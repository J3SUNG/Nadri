...
CREATE TABLE `log_attraction` (
  ...
  CONSTRAINT `fk_log_attraction_attraction_info1` FOREIGN KEY (`attraction_no`) REFERENCES `attraction_info` (`attraction_no`),
  CONSTRAINT `fk_log_attraction_user1` FOREIGN KEY (`user_no`) REFERENCES `user` (`user_no`) ON DELETE SET NULL
