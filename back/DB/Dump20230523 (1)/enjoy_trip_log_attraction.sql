...
CREATE TABLE `log_attraction` (
  ...
  KEY `fk_log_attraction_user1_idx` (`user_no`),
  ...
  CONSTRAINT `fk_log_attraction_user1` FOREIGN KEY (`user_no`) REFERENCES `user` (`user_no`) ON DELETE CASCADE
...
INSERT INTO `log_attraction` VALUES (2,'2023-05-23 04:16:15',125266,1),(3,'2023-05-23 04:16:52',125266,1),(4,'2023-05-23 04:17:17',125266,2),(5,'2023-05-23 04:17:18',125266,3),(6,'2023-05-23 04:17:19',125266,3),(7,'2023-05-23 04:17:21',125266,4),(8,'2023-05-23 04:17:22',125266,5),(9,'2023-05-23 04:17:23',125266,6),(10,'2023-05-23 04:17:24',125266,7),(11,'2023-05-23 04:17:25',125266,8),(12,'2023-05-23 04:17:26',125266,9),(13,'2023-05-23 04:17:28',125266,10);
