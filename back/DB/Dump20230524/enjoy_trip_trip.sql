...
INSERT INTO `trip` VALUES (1,1,'바뀐 메모',1,125266),(2,2,'첫번째 여행계획 아이템2',1,125405),(3,3,'첫번째 여행계획 아이템3',1,125406),(4,1,'미친 첫번째 아이템',2,125407),(5,2,'미친 두번째 아이템',2,125408),(7,1,'산이 곧 인생이다.',3,125465),(8,2,'산은 평화롭다.',3,125467),(9,3,'산은 산이요, 물은 물이다.',3,125465),(11,1,'비슬산의 맑은 공기!',5,125406),(12,2,'어린 시절 추억이 깃든 장소',5,126130),(13,3,'마음의 평화',5,126160);
